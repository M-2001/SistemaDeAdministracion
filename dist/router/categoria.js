...
router.put("/status", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], categoria.EstadoCategoria);
router.get("/categorias-paginated", categoria.MostrarCategoriasPaginadas);
router.post("/", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], categoria.AgregarCategoria);
router.get("/:id", jwt_1.CheckJwt, categoria.ObtenerCategoriaPorID);
router.put("/:id", jwt_1.CheckJwt, categoria.ActualizarCategoria);
router.delete("/:id", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], categoria.EliminarCategoria);
//estado del producto
