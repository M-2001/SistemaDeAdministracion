...
//estado del producto
router.put("/status", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], proveedor.EstadoProveedor);
router.get("/", proveedor.MostrarProveedors);
router.post("/", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], proveedor.AgregarProveedor);
router.get("/:id", proveedor.ObtenerProveedorPorID);
router.put("/:id", jwt_1.CheckJwt, proveedor.ActualizarProveedor);
router.delete("/:id", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], proveedor.EliminarProveedor);
