...
//empleados paginados
router.get('/empleado-paginated', [jwt_1.CheckJwt, role_1.checkRole(['admin'])], empleado.MostrarEmpleadosPaginados);
router.get('/:id', jwt_1.CheckJwt, empleado.getEmpleadoByID);
router.delete('/:id', [jwt_1.CheckJwt, role_1.checkRole(['admin'])], empleado.EliminarEmpleado);
