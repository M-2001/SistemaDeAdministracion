...
router.put('/status', [jwt_1.CheckJwt, (0, role_1.checkRole)(['admin'])], cupon.EstadoCupon);
...
router.delete('/destroy-cupon', [jwt_1.CheckJwt, (0, role_1.checkRole)(['admin'])], cupon.EliminarCupon);
