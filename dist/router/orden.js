...
router.post('/new-order', [jwt_1.CheckJwt, (0, roleUser_1.checkRoleU)(['user'])], ordenC.guardarOrden_DetalleOrden);
...
router.post('/add-reservation', [jwt_1.CheckJwt, (0, roleUser_1.checkRoleU)(['user'])], order.AddReservacion);
//Ruta para Cancelar una orden por parte de los clientes
router.post('/cancel-order', [jwt_1.CheckJwt, (0, roleUser_1.checkRoleU)(['user'])], order.CancelReservation);
