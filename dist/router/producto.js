...
router.post('/add-stock/:idp', [jwt_1.CheckJwt, (0, role_1.checkRole)(['admin'])], producto.AgregarProductoStock);
//eliminar image de producto
router.put('/file-product/:id', producto.EliminarImagenProducto);
//estado del producto
router.put('/status', [jwt_1.CheckJwt, (0, role_1.checkRole)(['admin'])], producto.EstadoProducto);
router.get('/bestSellers', producto.ProductosMasVendidos);
...
router.put('/:id', [jwt_1.CheckJwt, (0, role_1.checkRole)(['admin'])], producto.EditarProducto);
router.delete('/:id', [jwt_1.CheckJwt, (0, role_1.checkRole)(['admin'])], producto.EliminarProducto);
