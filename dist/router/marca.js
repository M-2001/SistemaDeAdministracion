...
router.post("/", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], marca.AgregarMarca);
router.put("/status", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], marca.EstadoMarca);
router.get("/:id", marca.ObtenerMarcaPorID);
router.put("/:id", jwt_1.CheckJwt, marca.ActualizarMarca);
router.delete("/:id", [jwt_1.CheckJwt, (0, role_1.checkRole)(["admin"])], marca.EliminarMarca);
